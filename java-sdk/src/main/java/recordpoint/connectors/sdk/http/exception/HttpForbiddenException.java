package recordpoint.connectors.sdk.http.exception;
...
public class HttpForbiddenException extends HttpResponseException {
    ...
    /**
     * Constructor that receives a {@link recordpoint.connectors.sdk.http.exception.HttpResponseException.Builder}.
     */
