 ...
 * </p>
 * <ul>
 *   <li>{@link recordpoint.connectors.sdk.service.ServiceSettings} - Encapsulates
 *       the configuration settings required for the SDK, including authentication details
 *       and service endpoints.</li>
 *   <li>{@link recordpoint.connectors.sdk.service.ServicePayload} - A marker interface
 *       for defining request payloads to be used in service operations.</li>
 *   <li>{@link recordpoint.connectors.sdk.service.ServiceResponse} - A marker interface
 *       for defining responses returned from service operations.</li>
 *   <li>{@link recordpoint.connectors.sdk.service.AbstractServiceRequest} - A base class
 *       for constructing service requests, supporting customizable request builders.</li>
 *   <li>{@link recordpoint.connectors.sdk.service.AbstractServiceClient} - An abstract
